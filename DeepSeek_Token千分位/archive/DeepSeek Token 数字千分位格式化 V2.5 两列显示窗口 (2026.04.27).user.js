    ...
    if (currentMode === 'simple') {
        ...
        TOKEN_DATA.models.forEach(m => {
            html += `
                <div class="model-item">
                    <div class="model-name">${m.name}</div>
                    <div class="hit-rate-row" style="font-size:28px;font-weight:700;color:#0f172a;text-align:center;margin-bottom:10px;">${m.hitRate}%</div>
                    <div class="two-col" style="display:grid;grid-template-columns:1fr 1fr;gap:0 16px;">
                        <div class="col">
                            <div class="row" style="display:flex;justify-content:space-between;align-items:baseline;font-size:12px;margin-bottom:4px;"><span class="label" style="color:#64748b;">✅ 命中</span><span class="value" style="font-weight:600;color:#1e293b;">${formatNumber(m.cacheHit)}</span></div>
                            <div class="row" style="display:flex;justify-content:space-between;align-items:baseline;font-size:12px;margin-bottom:4px;"><span class="label" style="color:#64748b;">⚡ 未命中</span><span class="value" style="font-weight:600;color:#1e293b;">${formatNumber(m.cacheMiss)}</span></div>
                        </div>
                        <div class="col">
                            <div class="row" style="display:flex;justify-content:space-between;align-items:baseline;font-size:12px;margin-bottom:4px;"><span class="label" style="color:#64748b;">📤 输出</span><span class="value" style="font-weight:600;color:#1e293b;">${formatNumber(m.output)}</span></div>
                            <div class="row" style="display:flex;justify-content:space-between;align-items:baseline;font-size:12px;margin-bottom:4px;"><span class="label" style="color:#64748b;">📊 输出占比</span><span class="value" style="font-weight:600;color:#1e293b;">${m.outputRate}%</span></div>
                        </div>
                    </div>
                </div>
            `;
