// ==UserScript==
// @name         DeepSeek Usage Token 千分位 & 缓存命中率 (整合版)
...
(function () {
    ...
    // 1. 偏好管理
    const PREF_KEYS = {
        masterSwitch: 'master_switch',      // 总开关
        displayMode: 'display_mode'          // 'simple' | 'full'
    };
    const DEFAULTS = {
        masterSwitch: true,
        displayMode: 'full'
