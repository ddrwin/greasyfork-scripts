...
// @note         2026.3.7  V2.4.4 新增必应、抖音、新浪搜索引擎；调整顺序为必应、百度、新浪、头条、抖音、小红书；设置面板双列布局；保存按钮改为 #008373 白字
...
(function() {
    ...
    const showSettingsPanel = () => {
        ...
        const panelWidth = 280; // 稍增宽度以适应双列布局
