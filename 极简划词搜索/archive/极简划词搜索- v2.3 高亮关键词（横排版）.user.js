...
// @note         2026.3.3  V2.3.0 彻底修复偏移量失效问题：计算位置前先设置 display:flex；优化代码结构
...
(function() {
    ...
    // ==================== 工具栏位置偏移量（图标个数）====================
    const OFFSET_LEFT_ICON_COUNT = 1.2;   // 正数左移，负数右移
    const OFFSET_DOWN_ICON_COUNT = 0.3;   // 正数下移，负数上移

    // ==================== 高亮分组 ====================
    const HIGHLIGHT_GROUPS = [
        { name: "白字红底", keywords: [], style: "background-color:#DE0422; color:#FFFFFF; /* font-weight:bold; */" },
        { name: "白字紫底", keywords: [], style: "background-color:#6633FF; color:#FFFFFF; /* font-weight:bold; */" },
        { name: "白字深绿底", keywords: [], style: "background-color:#008373; color:#FFFFFF; /* font-weight:bold; */" }
        { name: "红字黄底", keywords: [], style: "background-color:#FFFFCC; color:#FF0000; /* font-weight:bold; */" },
        { name: "绿字黄底", keywords: [], style: "background-color:#FFFFCC; color:#00CC00; /* font-weight:bold; */" },
    ];
