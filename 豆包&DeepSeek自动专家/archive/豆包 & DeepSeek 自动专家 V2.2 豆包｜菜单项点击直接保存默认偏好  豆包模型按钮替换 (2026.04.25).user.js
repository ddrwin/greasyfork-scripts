...
// @license      MIT
// @note         V1.5  豆包：引入默认思考模式，新对话/刷新自动切换为思考
// @note         V1.6  豆包：增加遥测拦截，屏蔽 opt.doubao.com 等埋点请求
// @note         V1.7  豆包：界面全宽化 + 发送气泡改为蓝色背景
// @note         V1.8  DeepSeek：自动切换专家模式，关闭智能搜索
// @note         V1.9  DeepSeek：对话窗口宽度扩展至 95%，表格区域全宽
// @note         V2.0  统一优化表格字体大小与间隙（豆包/DeepSeek）
// @note         V2.1  集成更宽的 DeepSeek 对话窗口与表格全宽样式
// @note         V2.2  豆包菜单项点击直接保存默认偏好（再也不去油猴菜单啦～）
// ==/UserScript==
