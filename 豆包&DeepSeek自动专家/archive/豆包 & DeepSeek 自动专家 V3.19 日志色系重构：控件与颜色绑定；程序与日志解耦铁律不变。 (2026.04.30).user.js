// ==UserScript==
// @name         豆包 & DeepSeek 自动专家 V3.19
// @namespace    https://github.com/ddrwin/ai-auto-expert
// @version      3.19
// @description  统一偏好管理、模块化站点控制、遥测拦截。V3.19：日志色系重构，每个控件固定主色调（模型切换=靛蓝、深度思考=翠绿、智能搜索=紫罗兰），子动作深浅区分。
...
// @license      MIT
// @note         2026.04.30 V3.19 日志色系重构：控件与颜色绑定；程序与日志解耦铁律不变。
// ==/UserScript==
