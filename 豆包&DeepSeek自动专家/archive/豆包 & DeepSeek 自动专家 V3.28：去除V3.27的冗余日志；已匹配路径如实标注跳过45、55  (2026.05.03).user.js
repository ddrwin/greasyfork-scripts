// ==UserScript==
// @name         豆包 & DeepSeek 自动专家 V3.28
// @namespace    https://github.com/ddrwin/ai-auto-expert
// @version      3.28
// @description  统一偏好管理、模块化站点控制、遥测拦截。V3.28：去除V3.27的冗余日志；已匹配路径如实标注跳过4/5、5/5。
...
// @license      MIT
// @note         2026.05.03 V3.28 去除已匹配路径的冗余日志；如实标注跳过步骤。
// ==/UserScript==
...
(function() {
    ...
    function createSiteController(config) {
        ...
        async function applyControl(control) {
            ...
            // ===== 【修改起点】深度思考 / 智能搜索流程（移除冗余日志） =====
            // 原因：V3.27在已匹配路径添加了虚假的4/5、5/5日志。V3.28移除，改为如实标注。
