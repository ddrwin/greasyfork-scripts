...
// @namespace
// @version      2.1
// @description  豆包：默认思考模式+遥测拦截+全宽+蓝色气泡；DeepSeek：自动专家模式+关闭智能搜索+全宽+表格全宽
...
// @note         2026.4.25  V2.0 优化表格字体大小，减小表格间隙；
// @note         2026.4.25  V2.1 集成更宽的 DeepSeek 对话窗口与表格全宽样式
// ==/UserScript==
