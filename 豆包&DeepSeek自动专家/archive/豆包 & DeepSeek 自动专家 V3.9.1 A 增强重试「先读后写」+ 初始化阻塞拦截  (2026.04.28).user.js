...
// @version      3.9.1-A
// @description  统一偏好管理、模块化站点控制、遥测拦截。豆包默认思考，DeepSeek 默认专家+深度思考。模型切换采用增强重试机制。拦截页面初始化阻塞请求。
...
// @license      MIT
// @note         2026.04.29  V3.9.1-A  新增拦截 hif-dliq.deepseek.com，消除其 DNS 解析失败造成的页面初始化阻塞，提升脚本生效速度。
// ==/UserScript==
