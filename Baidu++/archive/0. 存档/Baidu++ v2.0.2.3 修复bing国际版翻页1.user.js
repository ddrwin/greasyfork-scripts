...
// @note         2026.02.24 V2.1.3 优化 Bing 翻页配置：使用通用 CSS 选择器匹配下一页链接和搜索结果项，确保国际版页码提示正常显示。
// ==/UserScript==
            ...
            const configs = {
                ...
                google: {
                    nextLink: [
                        ...
                        "id('main')/footer//a[@aria-label and contains(@href, 'start=') and contains(., '>')]"
                    ],
                    pageElement: [
                ...
                bing: {
                    // 下一页链接：使用用户提供的通用 CSS 选择器
                    nextLink: "css;a[title='Next page'], a.sb_pagN, a.sb_halfnext, a.sb_fullnpl",
                    // 搜索结果项：使用用户提供的精准选择器
                    pageElement: "css;ol#b_results > li.b_algo",
                    // 插入点：直接追加到 b_results 末尾，确保页码提示和内容都能正常插入
                    HT_insert: ["id('b_results')", 2],
