...
// @note         2026.02.24 V2.2.0 融合东方永页机翻页规则：将东方永页机的精准选择器作为备选加入各搜索引擎配置，实现双保险机制，确保最大兼容性。
// ==/UserScript==
    ...
    class SitePagerConfig {
        ...
        _getFullPagerConfig() {
            ...
            const configs = {
                ...
                google: {
                    // 下一页链接候选：先尝试现有规则，再加入东方永页机的通用规则和古老页面规则
                    nextLink: [
                    ...
                    // 页面元素候选：先尝试现有规则，再加入东方永页机的通用规则和古老页面规则
                    pageElement: [
