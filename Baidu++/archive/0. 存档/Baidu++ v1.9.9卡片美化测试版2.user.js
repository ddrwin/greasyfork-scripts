...
// @note         2026.2.21 V1.9.9 最终调整：标题强制撑满、极致压缩空间、强制刷新机制
// ==/UserScript==
...
#content_left [class*="result"] {
    background: #E8F3E9 !important;      /* 护眼绿卡片背景 */
...
#content_left .result .source-container_3WKXu {
    color: #4CAF50 !important;      /* Lite 风格的绿色来源 */
